...
/**
  ...
  @retval EFI_INVALID_PARAMETER  The packet is mal-formatted
...
/**
  ...
  @retval EFI_INVALID_PARAMETER  The option is mal-formatted
...
/**
  ...
  @retval EFI_INVALID_PARAMETER  The packet option is mal-formatted
  @retval EFI_UNSUPPORTED        Some option isn't supported
  @retval EFI_SUCCESS            The option are OK and has been parsed.
